...
def LEAP_limits(hand="right"):
    ...
    if hand == "left":
        ...
        sim_min = np.array([-0.523599, -0.261799, -0.261799, -0.261799,-0.523599, -0.261799, -0.261799, -0.261799, -0.523599, -0.261799, -0.261799, -0.261799, -2.443, -2.094, -1.20, -1.34])
        sim_max = np.array([0.523599, 1.91986, 1.91986, 1.91986,  0.523599, 1.91986, 1.91986, 1.91986,  0.523599, 1.91986, 1.91986, 1.91986,  0.47,  0.349, 1.90,  1.88])
    else:
